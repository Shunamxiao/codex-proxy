...
Read the type spec:
```
Read: .Codex/skills/issue-create/references/issue-types.md
```
...
1. Read the chosen template:
   ```
   Read: .Codex/skills/issue-create/assets/<template>.md
   ```
2. Read the labels catalog:
   ```
   Read: .Codex/skills/issue-create/references/labels.md
   ```
